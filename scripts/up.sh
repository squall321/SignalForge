...
# --env-file 로 .env 전체를 넘긴다. 키를 하나씩 --env 로 나열하던 방식은
# 새 자격증명이 생길 때마다 조용히 빠졌다 — YOUTUBE_API_KEY 만 등재돼 있고
# REDDIT_CLIENT_ID/SECRET·BLUESKY_*·TWITTER_*·NAVER_*·SAMSUNG_* 은 전부
