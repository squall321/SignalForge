# Workflow Validate Meta — R25_capexp (iter 3)

생성 (UTC): 2026-06-05T23:13:18+00:00  
backend: `http://localhost:8000`  
available: `{'regression': True, 'coverage': True, 'topic_eval': True, 'crisis': False}`  
threshold: ±10%  
메타 재귀 cap: 4 iteration (현 iter=3)

## 1. 메타 파서 산출 (validator 자기 보고서의 표 셀 직접 파싱)

### `reports/r25_meta_cap_experiment/cap4/workflow_validate_R25_capexp_meta_iter2.md` — claim 37건, alert 5건
